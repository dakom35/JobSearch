...
\lhead{Dossier de compétences} % Add your subtitle here
\cfoot{\thepage}
...
\renewcommand{\maketitle}{%
    \begin{center} % Center the whole content
        ...
        \begin{minipage}[b]{0.3\linewidth}   % right minipage
            \raggedleft
            \vspace*{-3\baselineskip} % Adjust the vertical position of the image
            \includegraphics[width=0.6\linewidth]{moi.jpeg} \hspace{0.05\linewidth}
        \end{minipage}%
...
\begin{center}
    \begin{tikzpicture}
        \draw[mainBlue, line width=4pt] (-0.4\linewidth,-2pt) -- (0.4\linewidth,-2pt);
    \end{tikzpicture}
\end{center}
