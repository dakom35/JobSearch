...
% Fancyhdr settings for other pages
\fancypagestyle{otherpages}{
    ...
    \renewcommand{\headrule}{\color{ruleColor}\hrule width\headwidth height\headrulewidth \vskip-\headrulewidth} % Redefine color of header rule
}
